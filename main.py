네, 알겠습니다. 승리한 선수의 능력치를 강화하는 기능을 추가해 드릴게요.

이제 대결에서 승리한 선수는 **공격력 또는 수비력 중 하나가 무작위로 1 증가**합니다. 이로써 매 라운드 승리할 때마다 내 카드들이 더 강력해지는 재미를 느낄 수 있습니다.

아래는 이 기능이 추가된 최신 코드입니다.
